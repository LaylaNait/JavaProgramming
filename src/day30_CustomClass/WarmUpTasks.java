...
public class WarmUpTasks {
    public static void main(String[] args) {
        ...
        list.addAll(Arrays.asList(1,0,2,0,3,4,0));
...
2. Write a program that can remove all the zeros to the last indexes of ArrayList without creating another array
